...
<body>
	...
	<div class="container mt-5 position-relative" ng-app="app"
		...
		<div ng-if="isLoading"
			class="spinner-border text-primary position-absolute top-0 end-0"
			role="status">
		...
		<div class="tab-content" id="nav-tabContent">
			...
			<div class="tab-pane fade" id="nav-profile" role="tabpanel"
				...
				<div ng-if="noResult" class="alert alert-danger" role="alert">No
					one like this video.</div>
			</div>
